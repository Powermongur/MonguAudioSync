...
namespace Mongu_Audio_Sync
{
    ...
    {     
        ...
        {
            Form2 form2Dialog = new Form2();
            form2Dialog.Show();
        }

        private void button2_Click(object sender, EventArgs e)
        {
            Form3 form3Dialog = new Form3();
            form3Dialog.Show();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                textBox1.Text += "name:" + name + Environment.NewLine;
                if (name == app)
                {
                    // display mute state & volume level (% of master)
                    textBox1.Text += "Mute:" + GetApplicationMute(app) + Environment.NewLine;
                    textBox1.Text += "Volume:" + GetApplicationVolume(app) + Environment.NewLine + Environment.NewLine;
            ...
            /*foreach (uint id in EnumerateApplications2())
            {
                textBox1.Text += "name2:" + id.ToString() + Environment.NewLine;
            }*/
        ...
        public static IEnumerable<uint> EnumerateApplications2()
        {
            // get the speakers (1st render + multimedia) device
            IMMDeviceEnumerator deviceEnumerator = (IMMDeviceEnumerator)(new MMDeviceEnumerator());
            IMMDevice speakers;
